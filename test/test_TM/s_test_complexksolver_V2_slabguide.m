...
n_core      = n2;
lambda0     = lambda;
[ neff, k_analytical, kx_temp, alpha_temp, field_analy ] = solve_symm_slab( core_d, n_clad, n_core, lambda0, 'TE', true );
