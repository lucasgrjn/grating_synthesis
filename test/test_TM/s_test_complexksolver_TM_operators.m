% authors: bohan zhang
%
% script just for testing that the operators are correctly implemented
...
addpath( 'C:\Users\bz\Google Drive\research\popovic group\code\slab_modesolver' );
...
t_wg    = 200;
period  = disc*3;
domain  = [ disc*4, disc*2 ];     % dimensions x, z
...
% mode solved field
plot( y_coords - y_coords(end/2), abs(Phi_all( :, 1, 1 ))./max(abs(Phi_all( :, 1, 1 ))) );
% index distribution
