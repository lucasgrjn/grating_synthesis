...
if enforce_min_feat
    ...
    synth_obj = synth_obj.generate_final_design_gaussian( MFD, input_wg_type, fill_thresh, @f_enforce_min_feat_size );
else
    synth_obj = synth_obj.generate_final_design_gaussian( MFD, input_wg_type, fill_thresh );
end
