...
%   layer_thick
%       type: double, scalar
%       desc: OPTIONAL each layer thickness, defaults to 100nm
%
% outputs:
%   GC
...
wg_thick        = [ layer_thick, layer_thick ];
wg_min_y        = [ domain_y_half, domain_y_half-layer_thick ];
