...
%             eme_obj.plotDiel();
        ...
        function obj = synthesizeUniformGrating(obj, angle, MFD, fill_factor_top, fill_factor_bot)
            % Synthesizes a uniform grating at the desired angle 
            %
            % inputs:
            %   angle in deg
...
%             waveguide.plotEz_w_edges();
            ...
            % set fill factors
            n_fills     = 20;                                               % number of fill factor combinations to try
            fill_tops   = linspace( 0.95, fill_factor_top, n_fills );
            fill_bots   = linspace( 0.95, fill_factor_bot, n_fills );
