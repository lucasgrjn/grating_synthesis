...
%                     obj.sweep_variables.scatter_str_vs_fill_srad( ii )      = best_GC.alpha_up_from_srad;
        ...
        function obj = generate_final_design_uniform( obj, desired_field, input_wg_type, enforce_min_feat_size_func )
            ...
            [ obj, chosen_fills, chosen_periods, ...
                    ...
                    chosen_ks, chosen_directivity ] = obj.pick_design_half( input_wg_type );
            ...
            [ obj, synthesized_design ] = obj.pick_final_datapoints( ...
                                      ...
                                      chosen_directivity( indx_best_overlap ) );
        ...
        function [ obj, chosen_fills, chosen_periods, ...
                    chosen_angles, chosen_scatter_str, ...
                    chosen_ks, chosen_directivity ]...
                    = pick_design_half( obj, input_wg_type )
            ...
            switch input_wg_type
                case 'full'
                    ...
                    chosen_directivity  = obj.sweep_variables.directivities_vs_fill( 1:indx_max_scatter );
                case {'bottom', 'none'}
                    ...
                    chosen_directivity  = obj.sweep_variables.directivities_vs_fill( indx_max_scatter:end );
            end
        ...
        function [ obj, chosen_fills, chosen_periods, ... 
            ...
            chosen_directivity  = chosen_directivity(indices_to_keep);                   
...
% 
        ...
        function [ obj, synthesized_design ] = pick_final_datapoints( obj, ...
            ...
            %     directivity
            %         type: double, array
            %         desc: directivity from generated design space
            %     start_alpha_des
            %         type: double, scalar
            ...
            synthesized_design.directivity  = [];
            ...
            while cur_x < xvec(end)
                ...
                synthesized_design.directivity(ii) = chosen_directivity( indx_closest_scatter );
        ...
        function [ max_overlap, field_shape_prediction ] = predict_overlap_for_optimization( ...
                                              obj, xvec, alpha_des, ...
                                                ...
                                                chosen_ks, ...
                                                chosen_directivity, ...
                                                desired_field, start_alpha_power )
