...
%             figure;
%             plot( angle_vec_bot(real_a_indices_bot), abs(E_z_fx_down(real_a_indices_bot)) );
...
%             % DEBUG plot E_fz down
%             figure;
%             plot(1:length(E_z_fx_down), abs(E_z_fx_down) );
%             xlabel('array indx'); ylabel('E_z(f_x)');
%             title('DEBUG abs(E(f_x)) down, ALL');
%             makeFigureNice();
%             
%             % DEBUG plot E_fz up
%             figure;
%             plot( angle_vec_top(real_a_indices_top), abs(E_z_fx_up(real_a_indices_top)) );
%             xlabel('Rad. angle (deg)'); ylabel('E_z(f_x)');
...
%             % DEBUG plot E_fz up
%             figure;
%             plot(1:length(E_z_fx_up), abs(E_z_fx_up) );
%             xlabel('array indx'); ylabel('E_z(f_x)');
