function [] = f_run_synth_grating_v3( lambda, optimal_angle, BOX_thickness )
% authors: bohan
% 
% script for testing the latest synthesis object on the scc
% using the 45rf dimensions
%
% Inputs
%   lambda
%       wavelength
...
h_makeGratingCell   = @( dxy, units, lambda, background_index, y_domain_size, ...
                        ...
                        f_makeGratingCell_45RFSOI( dxy, units, lambda, background_index, y_domain_size, ...
...
savefig(['dir_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['dir_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['dir_b4_period_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['dir_b4_period_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['angle_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['angle_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['scatter_str_imag_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['scatter_str_imag_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['scatter_str_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['scatter_str_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['period_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['period_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['offsets_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['offsets_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['k_real_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['k_real_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
...
savefig(['k_imag_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.fig']);
saveas(gcf, ['k_imag_v_ff_' synth_obj.start_time 'lambda' num2str(lambda) '_optangle' num2str(optimal_angle) '_box' num2str(BOX_thickness) '.png']);
